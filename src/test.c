...
START_TEST(rm_bit_test) {
    s21_decimal test_dec, control_dec;
    init_dec(&test_dec);
...
START_TEST(template) {
    s21_decimal test_dec;
    s21_decimal control_dec = {0, 0, 0, 0x0, 0};
    init_dec(&test_dec);
    ck_assert_decimal_eq(test_dec, control_dec);
}
END_TEST
...
START_TEST(from_decimal_to_float_1) {
    float test_float;
    float control_float = 0.9;
    s21_decimal test_dec = {0x00000009, 0x00000000, 0x00000000, 0x00010000, 0x0};  /* 0.9 */
    s21_from_decimal_to_float(test_dec, &test_float);
    ck_assert_float_eq_tol(test_float, control_float, 0.0001);
}
END_TEST

START_TEST(from_decimal_to_float_2) {
    float test_float;
    float control_float = 1.9;
    s21_decimal test_dec = {0x00000013, 0x00000000, 0x00000000, 0x00010000, 0x0};  /* 1.9 */
    s21_from_decimal_to_float(test_dec, &test_float);
    ck_assert_float_eq_tol(test_float, control_float, 0.0001);
}
END_TEST
...
START_TEST(from_decimal_to_float_3) {
    float test_float;
    float control_float = -1.9;
    s21_decimal test_dec = {0x00000013, 0x00000000, 0x00000000, 0x80010000, 0x0};  /* -1.9 */
    s21_from_decimal_to_float(test_dec, &test_float);
    ck_assert_float_eq_tol(test_float, control_float, 0.0001);
}
END_TEST
...
START_TEST(from_decimal_to_float_4) {
    float test_float;
    float control_float = -6.3;
    s21_decimal test_dec = {0x0000003F, 0x00000000, 0x00000000, 0x80010000, 0x0};  /* -6.3 */
    s21_from_decimal_to_float(test_dec, &test_float);
    ck_assert_float_eq_tol(test_float, control_float, 0.0001);
}
END_TEST
...
START_TEST(from_decimal_to_float_5) {
    float test_float;
    s21_decimal test_dec = {0x00000000, 0x00000000, 0x00000000, 0x00000000, s21_NAN};  /* NAN */
    s21_from_decimal_to_float(test_dec, &test_float);
    ck_assert_float_nan(test_float);
}
END_TEST
...
START_TEST(from_decimal_to_int_1) {
    ...
    s21_from_decimal_to_int(test_dec, &test_int);
...
START_TEST(from_decimal_to_int_6) {
    int test_int = 0;
    int control_int = 0;
    s21_decimal dec = {0x00000009, 0x00000000, 0x00000000, 0x00010000, 0x0};  /* 0.9 */
    s21_from_decimal_to_int(dec, &test_int);
    ck_assert_int_eq(test_int, control_int);
}
END_TEST
...
START_TEST(from_decimal_to_int_7) {
    int test_int = 0;
    int control_int = 1;
    s21_decimal dec = {0x0000000F, 0x00000000, 0x00000000, 0x00010000, 0x0};  /* 1.5 */
    s21_from_decimal_to_int(dec, &test_int);
    ck_assert_int_eq(test_int, control_int);
}
END_TEST
...
START_TEST(from_decimal_to_int_8) {
    int test_int = 0;
    int control_int = -1;
    s21_decimal dec = {0x0000000F, 0x00000000, 0x00000000, 0x80010000, 0x0};  /* -1.5 */
    s21_from_decimal_to_int(dec, &test_int);
    ck_assert_int_eq(test_int, control_int);
}
END_TEST
...
START_TEST(dop_code_convert_test) {
    ...
    control_dec.value_type = s21_DOP_CODE;
    ck_assert_decimal_eq(test_dec, control_dec);
...
START_TEST(truncate_test_1) {
    s21_decimal dec = {0x0000000F, 0x00000000, 0x00000000, 0x00010000, 0x0};          /* 1.5 */
    s21_decimal control_dec = {0x00000001, 0x00000000, 0x00000000, 0x00000000, 0x0};  /* 1 */
    ck_assert_decimal_eq(s21_truncate(dec), control_dec);
}
END_TEST

START_TEST(truncate_test_2) {
    s21_decimal dec = {0x0000000F, 0x00000000, 0x00000000, 0x80010000, 0x0};          /* -1.5 */
    s21_decimal control_dec = {0x00000001, 0x00000000, 0x00000000, 0x80000000, 0x0};  /* -1 */
    ck_assert_decimal_eq(s21_truncate(dec), control_dec);
}
END_TEST

START_TEST(truncate_test_3) {
    s21_decimal dec = {0x00000005, 0x00000000, 0x00000000, 0x00010000, 0x0};          /* 0.5 */
    s21_decimal control_dec = {0x00000000, 0x00000000, 0x00000000, 0x00000000, 0x0};  /* 0 */
    ck_assert_decimal_eq(s21_truncate(dec), control_dec);
}
END_TEST

START_TEST(truncate_test_4) {
    s21_decimal dec = {0x00000005, 0x00000000, 0x00000000, 0x80010000, 0x0};          /* -0.5 */
    s21_decimal control_dec = {0x00000000, 0x00000000, 0x00000000, 0x80000000, 0x0};  /* 0 */
    ck_assert_decimal_eq(s21_truncate(dec), control_dec);
}
END_TEST

START_TEST(less_norm_1) {
    s21_decimal dec1 = {0x00000001, 0x00000000, 0x00000000, 0x00000000, 0x0};  /* 1 */
    s21_decimal dec2 = {0x1A1DA4C1, 0x24506695, 0x000006D8, 0x80060000, 0x0};  /* -32321312321313211.000001 */
    ck_assert_int_eq(s21_is_less(dec1, dec2), FALSE);
}
END_TEST

START_TEST(less_norm_2) {
    s21_decimal dec1 = {0x00000001, 0x00000000, 0x00000000, 0x00090000, 0x0};  /* 0.000000001 */
    s21_decimal dec2 = {0x1A1DA4C1, 0x24506695, 0x000006D8, 0x00060000, 0x0};  /* 32321312321313211.000001 */
    ck_assert_int_eq(s21_is_less(dec1, dec2), TRUE);
}
END_TEST

START_TEST(less_norm_3) {
    s21_decimal dec1 = {0x000003E7, 0x00000000, 0x00000000, 0x00080000, 0x0};  /* 0.00000999 */
    s21_decimal dec2 = {0x00000002, 0x00000000, 0x00000000, 0x80000000, 0x0};  /* -2 */
    ck_assert_int_eq(s21_is_less(dec1, dec2), FALSE);
}
END_TEST

START_TEST(less_norm_4) {
    s21_decimal dec1 = {0xDE2FD313, 0x047C5A15, 0x00000000, 0x80040000, 0x0};  /* -32323232323232.2323 */
    s21_decimal dec2 = {0x000003E7, 0x00000000, 0x00000000, 0x000E0000, 0x0};  /* 0.00000000000999 */
    ck_assert_int_eq(s21_is_less(dec1, dec2), TRUE);
}
END_TEST
...
START_TEST(less_NANs) {
    ...
    ck_assert_int_eq(res, s21_is_less(y, x));
}
END_TEST
...
START_TEST(less_1_NEG_INF_2_INF) {
    s21_decimal x, y;
    int res = 0;  /* x < y */
    init_dec(&x);
    init_dec(&y);
    ...
    ck_assert_int_eq(res, s21_is_less(x, y));
}
END_TEST
...
START_TEST(equal_norm_1) {
    s21_decimal dec1 = {0x00000001, 0x00000000, 0x00000000, 0x00030000, 0x0};  /* 0.001 */
    s21_decimal dec2 = {0x00000001, 0x00000000, 0x00000000, 0x00030000, 0x0};  /* 0.001 */
    ck_assert_int_eq(s21_is_equal(dec1, dec2), TRUE);
}
END_TEST

START_TEST(equal_norm_2) {
    s21_decimal dec1 = {0x00002EE0, 0x00000000, 0x00000000, 0x00030000, 0x0};  /* 12.000 */
    s21_decimal dec2 = {0x0000000C, 0x00000000, 0x00000000, 0x00000000, 0x0};  /* 12 */
    ck_assert_int_eq(s21_is_equal(dec1, dec2), TRUE);
}
END_TEST
...
START_TEST(equal_norm_3) {
    ...
    ck_assert_int_eq(res, s21_is_equal(x, y));
}
END_TEST
...
START_TEST(not_equal_norm_1) {
    ...
    ck_assert_int_eq(res, s21_is_not_equal(x, y));
}
END_TEST
...
START_TEST(less_equal_norm_1) {
    ...
    ck_assert_int_eq(res, s21_is_less_or_equal(x, y));
}
END_TEST
...
START_TEST(less_equal_norm_5) {
    s21_decimal dec1 = {0x00000003, 0x00000000, 0x00000000, 0x00000000, 0x0};  /* 3 */
    s21_decimal dec2 = {0x00000002, 0x00000000, 0x00000000, 0x00000000, 0x0};  /* 2 */
...
START_TEST(greater_norm_1) {
    s21_decimal dec1 = {0x50BCAC9A, 0x00000000, 0x00000000, 0x00030000, 0x0};  /* 1354542.234 */
    s21_decimal dec2 = {0x74ED9B81, 0xE758E637, 0x00000019, 0x00060000, 0x0};  /* 477838928989310.000001 */
    ck_assert_int_eq(s21_is_greater(dec1, dec2), FALSE);
}
END_TEST

START_TEST(greater_norm_2) {
    s21_decimal dec1 = {0x000007F2, 0x00000000, 0x00000000, 0x00080000, 0x0};  /* 0.00002034 */
    s21_decimal dec2 = {0x74ED9B81, 0xE758E637, 0x00000019, 0x80060000, 0x0};  /* -477838928989310.000001 */
    ck_assert_int_eq(s21_is_greater(dec1, dec2), TRUE);
}
END_TEST

START_TEST(greater_norm_3) {
    s21_decimal dec1 = {0x000007F2, 0x00000000, 0x00000000, 0x80080000, 0x0};  /* -0.00002034 */
    s21_decimal dec2 = {0x23FF5B81, 0x00A9C7D5, 0x00000000, 0x80060000, 0x0};  /* -47788989310.000001 */
    ck_assert_int_eq(s21_is_greater(dec1, dec2), TRUE);
}
END_TEST

START_TEST(greater_norm_4) {
    s21_decimal dec1 = {0x00000001, 0x00000000, 0x00000000, 0x800E0000, 0x0};  /* -0.00000000000001 */
    s21_decimal dec2 = {0x1A1DA4C1, 0x24506695, 0x000006D8, 0x00060000, 0x0};  /* 32321312321313211.000001 */
    ck_assert_int_eq(s21_is_greater(dec1, dec2), FALSE);
}
END_TEST
...
START_TEST(greater_norm_5) {
    s21_decimal dec1 = {0x00000001, 0x00000000, 0x00000000, 0x000E0000, 0x0};  /* 0.00000000000001 */
    s21_decimal dec2 = {0x1A1DA4C1, 0x24506695, 0x000006D8, 0x80060000, 0x0};  /* -32321312321313211.000001 */
    ck_assert_int_eq(s21_is_greater(dec1, dec2), TRUE);
}
END_TEST
...
START_TEST(greater_norm_6) {
    s21_decimal dec1 = {0x00000002, 0x00000000, 0x00000000, 0x00000000, 0x0};  /* 2 */
    s21_decimal dec2 = {0x00000003, 0x00000000, 0x00000000, 0x00000000, 0x0};  /* 3 */
    ck_assert_int_eq(s21_is_greater(dec1, dec2), FALSE);
}
END_TEST
...
START_TEST(greater_INFs) {
    ...
    ck_assert_int_eq(res, s21_is_greater(x, y));
}
END_TEST
...
START_TEST(normalization_test) {
    s21_decimal test_dec = {0x00000001, 0x00000000, 0x00000000, 0x00000000, 0x0};
    s21_decimal tmp_dec = {0x0000000F, 0x00000000, 0x00000000, 0x00010000, 0x0};
    s21_decimal control_dec = {0x0000000A, 0x00000000, 0x00000000, 0x00010000, 0x0};
...
START_TEST(normalization_test_1) {
    s21_decimal test_dec = {0x00000001, 0x00000000, 0x00000000, 0x00000000, 0x0};
    s21_decimal tmp_dec = {0x00000001, 0x00000000, 0x00000000, 0x00090000, 0x0};
    s21_decimal control_dec = {0x3B9ACA00, 0x00000000, 0x00000000, 0x00090000, 0x0};
    normalize(&test_dec, &tmp_dec);
    ck_assert_decimal_eq(test_dec, control_dec);
}
END_TEST
...
START_TEST(normalization_test_2) {
    s21_decimal test_dec = {0xFFFFFFFE, 0xFFFFFFFF, 0xFFFFFFFF, 0x00000000, 0x0};
    /* 79228162514264337593543950334 */
    s21_decimal tmp_dec = {0x00000001, 0x00000000, 0x00000000, 0x00090000, 0x0};
    s21_decimal control_dec = {0xFFFFFFFE, 0xFFFFFFFF, 0xFFFFFFFF, 0x00000000, 0x0};
    /* 79228162514264337593543950334 */
    normalize(&test_dec, &tmp_dec);
    ck_assert_decimal_eq(test_dec, control_dec);
}
...
START_TEST(add_test_1) {
    s21_decimal dec1 = {0x00000005, 0x00000000, 0x00000000, 0x00000000, 0x0};         /* 5 */
    s21_decimal dec2 = {0x00000003, 0x00000000, 0x00000000, 0x00000000, 0x0};         /* 3 */
    s21_decimal control_dec = {0x00000008, 0x00000000, 0x00000000, 0x00000000, 0x0};  /* 8 */
    ck_assert_decimal_eq(s21_add(dec1, dec2), control_dec);
}
END_TEST
...
START_TEST(add_test_2) {
    s21_decimal dec1 = {0x00000003, 0x00000000, 0x00000000, 0x00000000, 0x0};         /* 3 */
    s21_decimal dec2 = {0x00000003, 0x00000000, 0x00000000, 0x00000000, 0x0};         /* 3 */
    s21_decimal control_dec = {0x00000006, 0x00000000, 0x00000000, 0x00000000, 0x0};  /* 6 */
    ck_assert_decimal_eq(s21_add(dec1, dec2), control_dec);
}
END_TEST

START_TEST(add_test_3) {
    s21_decimal dec1 = {0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF, 0x00000000, 0x0};
    /* 79228162514264337593543950335 */
    s21_decimal dec2 = {0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF, 0x80000000, 0x0};
    /* -79228162514264337593543950335 */
    s21_decimal control_dec = {0x00000000, 0x00000000, 0x00000000, 0x00000000, 0x0};  /* 0 */
    ck_assert_decimal_eq(s21_add(dec1, dec2), control_dec);
}
...
START_TEST(add_test_4) {
    s21_decimal dec1 = {0x00000001, 0x00000000, 0x00000000, 0x001C0000, 0x0};
    /* 0.0000000000000000000000000001 */
    s21_decimal dec2 = {0x00000003, 0x00000000, 0x00000000, 0x00000000, 0x0};  /* 3 */
    s21_decimal control_dec = {0x30000001, 0xBA6F0723, 0x60EF6B1A, 0x001C0000, 0x0};
...
START_TEST(add_test_5) {
    s21_decimal dec1 = {0x00000000, 0x00000000, 0x00000000, 0x00000000, 0x0};  /* 0 */
    s21_decimal dec2 = {0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF, 0x00000000, 0x0};
    /* 79228162514264337593543950335 */
    s21_decimal control_dec = {0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF, 0x00000000, 0x0};
    /* 79228162514264337593543950335 */
    ck_assert_decimal_eq(s21_add(dec1, dec2), control_dec);
}
END_TEST
...
START_TEST(add_test_6) {
    s21_decimal dec1 = {0x00000007, 0x00000000, 0x00000000, 0x80000000, 0x0};         /* -7 */
    s21_decimal dec2 = {0x00000003, 0x00000000, 0x00000000, 0x00000000, 0x0};         /* 3 */
    s21_decimal control_dec = {0x00000004, 0x00000000, 0x00000000, 0x80000000, 0x0};  /* -4 */
    ck_assert_decimal_eq(s21_add(dec1, dec2), control_dec);
}
END_TEST

START_TEST(add_test_7) {
    s21_decimal dec1 = {0x00000003, 0x00000000, 0x00000000, 0x80000000, 0x0};         /* -3 */
    s21_decimal dec2 = {0x00000007, 0x00000000, 0x00000000, 0x00000000, 0x0};         /* 7 */
    s21_decimal control_dec = {0x00000004, 0x00000000, 0x00000000, 0x00000000, 0x0};  /* 4 */
    ck_assert_decimal_eq(s21_add(dec1, dec2), control_dec);
}
END_TEST

START_TEST(add_test_8) {
    s21_decimal dec1 = {0x00000007, 0x00000000, 0x00000000, 0x00000000, 0x0};         /* 7 */
    s21_decimal dec2 = {0x00000003, 0x00000000, 0x00000000, 0x80000000, 0x0};         /* -3 */
    s21_decimal control_dec = {0x00000004, 0x00000000, 0x00000000, 0x00000000, 0x0};  /* 4 */
    ck_assert_decimal_eq(s21_add(dec1, dec2), control_dec);
}
END_TEST
...
START_TEST(add_test_9) {
    s21_decimal dec1 = {0x00000003, 0x00000000, 0x00000000, 0x00000000, 0x0};         /* 3 */
    s21_decimal dec2 = {0x00000007, 0x00000000, 0x00000000, 0x80000000, 0x0};         /* -7 */
    s21_decimal control_dec = {0x00000004, 0x00000000, 0x00000000, 0x80000000, 0x0};  /* -4 */
    ck_assert_decimal_eq(s21_add(dec1, dec2), control_dec);
}
END_TEST
...
START_TEST(add_test_11) {
    s21_decimal x = {0x000003E8, 0x00000000, 0x00000000, 0x00000000, 0x0};  /* 1000 */
    s21_decimal y = {0x00000001, 0x00000000, 0x00000000, 0x001C0000, 0x0};
    /* 0.0000000000000000000000000001 */
    s21_decimal control_dec = {0x10000000, 0x3E250261, 0x204FCE5E, 0x00190000, 0x0};
    /* 1000.0000000000000000000000000 */
    ck_assert_decimal_eq(s21_add(x, y), control_dec);
}
END_TEST

START_TEST(add_test_12) {
    s21_decimal dec1 = {0x00000005, 0x00000000, 0x00000000, 0x001C0000, 0x0};
    /* 0.0000000000000000000000000005 */
    s21_decimal dec2 = {0x0000000A, 0x00000000, 0x00000000, 0x00000000, 0x0};  /* 10 */
    s21_decimal control_dec = {0x10000000, 0x3E250261, 0x204FCE5E, 0x001B0000, 0x0};
...
START_TEST(add_test_13) {
    s21_decimal dec1 = {0x0000000F, 0x00000000, 0x00000000, 0x001C0000, 0x0};
    /* 0.0000000000000000000000000015 */
    s21_decimal dec2 = {0x0000000A, 0x00000000, 0x00000000, 0x00000000, 0x0};  /* 10 */
    s21_decimal control_dec = {0x10000002, 0x3E250261, 0x204FCE5E, 0x001B0000, 0x0};
...
START_TEST(add_test_14) {
    s21_decimal dec1 = {0x00000019, 0x00000000, 0x00000000, 0x001C0000, 0x0};
...
START_TEST(add_test_15) {
    s21_decimal dec1 = {0x00000023, 0x00000000, 0x00000000, 0x001C0000, 0x0};
    /* 0.0000000000000000000000000035 */
    s21_decimal dec2 = {0x0000000A, 0x00000000, 0x00000000, 0x00000000, 0x0};  /* 10 */
    s21_decimal control_dec = {0x10000004, 0x3E250261, 0x204FCE5E, 0x001B0000, 0x0};
...
START_TEST(add_test_16) {
    s21_decimal dec1 = {0x0000002D, 0x00000000, 0x00000000, 0x001C0000, 0x0};
...
START_TEST(add_test_17) {
    s21_decimal dec1 = {0x00000037, 0x00000000, 0x00000000, 0x001C0000, 0x0};
    /* 0.0000000000000000000000000055 */
    s21_decimal dec2 = {0x0000000A, 0x00000000, 0x00000000, 0x00000000, 0x0};  /* 10 */
    s21_decimal control_dec = {0x10000006, 0x3E250261, 0x204FCE5E, 0x001B0000, 0x0};
...
START_TEST(add_test_18) {
    s21_decimal dec1 = {0x00000041, 0x00000000, 0x00000000, 0x001C0000, 0x0};
...
START_TEST(add_test_19) {
    s21_decimal dec1 = {0x0000004B, 0x00000000, 0x00000000, 0x001C0000, 0x0};
    /* 0.0000000000000000000000000075 */
    s21_decimal dec2 = {0x0000000A, 0x00000000, 0x00000000, 0x00000000, 0x0};  /* 10 */
    s21_decimal control_dec = {0x10000008, 0x3E250261, 0x204FCE5E, 0x001B0000, 0x0};
...
START_TEST(add_test_20) {
    s21_decimal dec1 = {0x00000055, 0x00000000, 0x00000000, 0x001C0000, 0x0};
...
START_TEST(add_test_21) {
    s21_decimal dec1 = {0x0000005F, 0x00000000, 0x00000000, 0x001C0000, 0x0};
    /* 0.0000000000000000000000000095 */
    s21_decimal dec2 = {0x0000000A, 0x00000000, 0x00000000, 0x00000000, 0x0};  /* 10 */
    s21_decimal control_dec = {0x1000000A, 0x3E250261, 0x204FCE5E, 0x001B0000, 0x0};
...
START_TEST(add_test_22) {
    s21_decimal dec1 = {0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF, 0x00000000, 0x0};
    /* 79228162514264337593543950335 */
    s21_decimal dec2 = {0x00000001, 0x00000000, 0x00000000, 0x00000000, 0x0};  /* 1 */
    s21_decimal control_dec = {0x00000000, 0x00000000, 0x00000000, 0x00000000, s21_INFINITY};  /* 0 */
    ck_assert_decimal_eq(s21_add(dec1, dec2), control_dec);
}
END_TEST

START_TEST(add_test_23) {
    s21_decimal dec1 = {0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF, 0x80000000, 0x0};
    /* -79228162514264337593543950335 */
    s21_decimal dec2 = {0x00000001, 0x00000000, 0x00000000, 0x80000000, 0x0};  /* -1 */
    s21_decimal control_dec = {0x00000000, 0x00000000, 0x00000000, 0x00000000, s21_NEGATIVE_INFINITY};  /* 0
    */
    ck_assert_decimal_eq(s21_add(dec1, dec2), control_dec);
}
END_TEST
...
START_TEST(add_test_24) {
    s21_decimal dec1 = {0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF, 0x80000000, s21_NAN};
    /* -79228162514264337593543950335 */
    s21_decimal dec2 = {0x00000001, 0x00000000, 0x00000000, 0x80000000, 0x0};  /* -1 */
    s21_decimal control_dec = {0x00000000, 0x00000000, 0x00000000, 0x00000000, s21_NAN};  /* 0 */
    ck_assert_decimal_eq(s21_add(dec1, dec2), control_dec);
}
END_TEST
...
START_TEST(add_test_25) {
    s21_decimal dec1 = {0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF, 0x80000000, 0x0};
    /* -79228162514264337593543950335 */
    s21_decimal dec2 = {0x00000001, 0x00000000, 0x00000000, 0x80000000, s21_NAN};  /* -1 */
    s21_decimal control_dec = {0x00000000, 0x00000000, 0x00000000, 0x00000000, s21_NAN};  /* 0 */
    ck_assert_decimal_eq(s21_add(dec1, dec2), control_dec);
}
END_TEST
...
START_TEST(add_test_26) {
    s21_decimal dec1 = {0x00000000, 0x00000000, 0x00000000, 0x00000000, s21_INFINITY};
    /* -79228162514264337593543950335 */
    s21_decimal dec2 = {0x00000001, 0x00000000, 0x00000000, 0x80000000, 0x0};  /* -1 */
    s21_decimal control_dec = {0x00000000, 0x00000000, 0x00000000, 0x00000000, s21_INFINITY};  /* 0 */
    ck_assert_decimal_eq(s21_add(dec1, dec2), control_dec);
...
START_TEST(add_test_27) {
    s21_decimal dec1 = {0x00000000, 0x00000000, 0x00000000, 0x00000000, s21_NEGATIVE_INFINITY};
    /* -79228162514264337593543950335 */
    s21_decimal dec2 = {0x00000001, 0x00000000, 0x00000000, 0x80000000, 0x0};  /* -1 */
    s21_decimal control_dec = {0x00000000, 0x00000000, 0x00000000, 0x00000000, s21_NEGATIVE_INFINITY};  /* 0
    */
...
START_TEST(sub_test_1) {
    ...
    s21_decimal dec2 = {0x00000001, 0x00000000, 0x00000000, 0x00000000, 0x0};         /* 1 */
    s21_decimal control_dec = {0x00000000, 0x00000000, 0x00000000, 0x00000000, 0x0};  /* 0 */
    ck_assert_decimal_eq(s21_sub(dec1, dec2), control_dec);
}
END_TEST
...
START_TEST(sub_test_3) {
    s21_decimal dec1 = {0x00000003, 0x00000000, 0x00000000, 0x80000000, 0x0};         /* -3 */
    s21_decimal dec2 = {0x00000002, 0x00000000, 0x00000000, 0x00000000, 0x0};         /* 2 */
    s21_decimal control_dec = {0x00000005, 0x00000000, 0x00000000, 0x80000000, 0x0};  /* -5 */
    ck_assert_decimal_eq(s21_sub(dec1, dec2), control_dec);
}
END_TEST

START_TEST(sub_test_4) {
    s21_decimal dec1 = {0x00000002, 0x00000000, 0x00000000, 0x80000000, 0x0};         /* -2 */
    s21_decimal dec2 = {0x00000003, 0x00000000, 0x00000000, 0x00000000, 0x0};         /* 3 */
    s21_decimal control_dec = {0x00000005, 0x00000000, 0x00000000, 0x80000000, 0x0};  /* -5 */
    ck_assert_decimal_eq(s21_sub(dec1, dec2), control_dec);
}
...
START_TEST(sub_test_5) {
    s21_decimal dec1 = {0x00000003, 0x00000000, 0x00000000, 0x00000000, 0x0};         /* 3 */
    s21_decimal dec2 = {0x00000002, 0x00000000, 0x00000000, 0x80000000, 0x0};         /* -2 */
    s21_decimal control_dec = {0x00000005, 0x00000000, 0x00000000, 0x00000000, 0x0};  /* 5 */
    ck_assert_decimal_eq(s21_sub(dec1, dec2), control_dec);
}
END_TEST
...
START_TEST(sub_test_8) {
    s21_decimal dec1 = {0x00000001, 0x00000000, 0x00000000, 0x00000000, 0x0};  /* 1 */
    s21_decimal dec2 = {0x00000001, 0x00000000, 0x00000000, 0x00190000, 0x0};
    /* 0.0000000000000000000000001 */
    s21_decimal control_dec = {0x49FFFFFF, 0x16140148, 0x00084595, 0x00190000, 0x0};
...
START_TEST(overflow_control_test) {
    s21_decimal x = {0x0, 0x0, 0xFFFFFFFF, 0x0, 0x0};
...
START_TEST(greater_equal_norm_1) {
    ...
    ck_assert_int_eq(res, s21_is_greater_or_equal(x, y));
}
END_TEST
...
START_TEST(round_test_1) {
    s21_decimal dec = {0x00000005, 0x00000000, 0x00000000, 0x00010000, 0x0};          /* 0.5 */
    s21_decimal control_dec = {0x00000000, 0x00000000, 0x00000000, 0x00000000, 0x0};  /* 0 */
    ck_assert_decimal_eq(s21_round(dec), control_dec);
}
END_TEST

START_TEST(round_test_2) {
    s21_decimal dec = {0x0000000F, 0x00000000, 0x00000000, 0x00010000, 0x0};          /* 1.5 */
    s21_decimal control_dec = {0x00000002, 0x00000000, 0x00000000, 0x00000000, 0x0};  /* 2 */
    ck_assert_decimal_eq(s21_round(dec), control_dec);
}
END_TEST

START_TEST(round_test_3) {
    s21_decimal dec = {0x00000019, 0x00000000, 0x00000000, 0x00010000, 0x0};          /* 2.5 */
    s21_decimal control_dec = {0x00000002, 0x00000000, 0x00000000, 0x00000000, 0x0};  /* 2 */
    ck_assert_decimal_eq(s21_round(dec), control_dec);
}
END_TEST
...
START_TEST(round_test_4) {
    s21_decimal dec = {0x00000023, 0x00000000, 0x00000000, 0x00010000, 0x0};          /* 3.5 */
    s21_decimal control_dec = {0x00000004, 0x00000000, 0x00000000, 0x00000000, 0x0};  /* 4 */
    ck_assert_decimal_eq(s21_round(dec), control_dec);
}
END_TEST
...
START_TEST(round_test_5) {
    s21_decimal dec = {0x0000002D, 0x00000000, 0x00000000, 0x00010000, 0x0};          /* 4.5 */
    s21_decimal control_dec = {0x00000004, 0x00000000, 0x00000000, 0x00000000, 0x0};  /* 4 */
    ck_assert_decimal_eq(s21_round(dec), control_dec);
}
END_TEST
...
START_TEST(round_test_6) {
    s21_decimal dec = {0x00000037, 0x00000000, 0x00000000, 0x00010000, 0x0};          /* 5.5 */
    s21_decimal control_dec = {0x00000006, 0x00000000, 0x00000000, 0x00000000, 0x0};  /* 6 */
    ck_assert_decimal_eq(s21_round(dec), control_dec);
}
END_TEST
...
START_TEST(round_test_7) {
    s21_decimal dec = {0x00000041, 0x00000000, 0x00000000, 0x00010000, 0x0};          /* 6.5 */
    s21_decimal control_dec = {0x00000006, 0x00000000, 0x00000000, 0x00000000, 0x0};  /* 6 */
    ck_assert_decimal_eq(s21_round(dec), control_dec);
}
END_TEST
...
START_TEST(round_test_8) {
    s21_decimal dec = {0x0000004B, 0x00000000, 0x00000000, 0x00010000, 0x0};          /* 7.5 */
    s21_decimal control_dec = {0x00000008, 0x00000000, 0x00000000, 0x00000000, 0x0};  /* 8 */
    ck_assert_decimal_eq(s21_round(dec), control_dec);
}
END_TEST
...
START_TEST(round_test_9) {
    s21_decimal dec = {0x00000055, 0x00000000, 0x00000000, 0x00010000, 0x0};          /* 8.5 */
    s21_decimal control_dec = {0x00000008, 0x00000000, 0x00000000, 0x00000000, 0x0};  /* 8 */
    ck_assert_decimal_eq(s21_round(dec), control_dec);
}
END_TEST
...
START_TEST(round_test_10) {
    s21_decimal dec = {0x0000005F, 0x00000000, 0x00000000, 0x00010000, 0x0};          /* 9.5 */
    s21_decimal control_dec = {0x0000000A, 0x00000000, 0x00000000, 0x00000000, 0x0};  /* 10 */
    ck_assert_decimal_eq(s21_round(dec), control_dec);
}
END_TEST
...
START_TEST(round_test_12) {
    s21_decimal dec = {0x0000000F, 0x00000000, 0x00000000, 0x80010000, 0x0};          /* -1.5 */
    s21_decimal control_dec = {0x00000002, 0x00000000, 0x00000000, 0x80000000, 0x0};  /* -2 */
    ck_assert_decimal_eq(s21_round(dec), control_dec);
}
END_TEST

START_TEST(round_test_13) {
    s21_decimal dec = {0x00000019, 0x00000000, 0x00000000, 0x80010000, 0x0};          /* -2.5 */
    s21_decimal control_dec = {0x00000002, 0x00000000, 0x00000000, 0x80000000, 0x0};  /* -2 */
    ck_assert_decimal_eq(s21_round(dec), control_dec);
}
END_TEST
...
START_TEST(round_test_14) {
    s21_decimal dec = {0x00000023, 0x00000000, 0x00000000, 0x80010000, 0x0};          /* -3.5 */
    s21_decimal control_dec = {0x00000004, 0x00000000, 0x00000000, 0x80000000, 0x0};  /* -4 */
    ck_assert_decimal_eq(s21_round(dec), control_dec);
}
END_TEST
...
START_TEST(round_test_15) {
    s21_decimal dec = {0x0000002D, 0x00000000, 0x00000000, 0x80010000, 0x0};          /* -4.5 */
    s21_decimal control_dec = {0x00000004, 0x00000000, 0x00000000, 0x80000000, 0x0};  /* -4 */
    ck_assert_decimal_eq(s21_round(dec), control_dec);
}
END_TEST
...
START_TEST(round_test_16) {
    s21_decimal dec = {0x00000037, 0x00000000, 0x00000000, 0x80010000, 0x0};          /* -5.5 */
    s21_decimal control_dec = {0x00000006, 0x00000000, 0x00000000, 0x80000000, 0x0};  /* -6 */
    ck_assert_decimal_eq(s21_round(dec), control_dec);
}
END_TEST

START_TEST(round_test_17) {
    s21_decimal dec = {0x00000041, 0x00000000, 0x00000000, 0x80010000, 0x0};          /* -6.5 */
    s21_decimal control_dec = {0x00000006, 0x00000000, 0x00000000, 0x80000000, 0x0};  /* -6 */
    ck_assert_decimal_eq(s21_round(dec), control_dec);
}
END_TEST
...
START_TEST(round_test_18) {
    s21_decimal dec = {0x0000004B, 0x00000000, 0x00000000, 0x80010000, 0x0};          /* -7.5 */
    s21_decimal control_dec = {0x00000008, 0x00000000, 0x00000000, 0x80000000, 0x0};  /* -8 */
    ck_assert_decimal_eq(s21_round(dec), control_dec);
}
END_TEST

START_TEST(round_test_19) {
    s21_decimal dec = {0x00000055, 0x00000000, 0x00000000, 0x80010000, 0x0};          /* -8.5 */
    s21_decimal control_dec = {0x00000008, 0x00000000, 0x00000000, 0x80000000, 0x0};  /* -8 */
    ck_assert_decimal_eq(s21_round(dec), control_dec);
}
END_TEST
...
START_TEST(round_test_20) {
    s21_decimal dec = {0x0000005F, 0x00000000, 0x00000000, 0x80010000, 0x0};          /* -9.5 */
    s21_decimal control_dec = {0x0000000A, 0x00000000, 0x00000000, 0x80000000, 0x0};  /* -10 */
    ck_assert_decimal_eq(s21_round(dec), control_dec);
}
END_TEST

START_TEST(round_test_21) {
    s21_decimal dec = {0x0000000D, 0x00000000, 0x00000000, 0x80010000, 0x0};          /* -1.3 */
    s21_decimal control_dec = {0x00000001, 0x00000000, 0x00000000, 0x80000000, 0x0};  /* -1 */
    ck_assert_decimal_eq(s21_round(dec), control_dec);
}
END_TEST
...
START_TEST(round_test_22) {
    s21_decimal dec = {0x0000000D, 0x00000000, 0x00000000, 0x00010000, 0x0};          /* 1.3 */
    s21_decimal control_dec = {0x00000001, 0x00000000, 0x00000000, 0x00000000, 0x0};  /* 1 */
    ck_assert_decimal_eq(s21_round(dec), control_dec);
}
END_TEST
...
START_TEST(round_test_23) {
    s21_decimal dec = {0x00000011, 0x00000000, 0x00000000, 0x00010000, 0x0};          /* 1.7 */
    s21_decimal control_dec = {0x00000002, 0x00000000, 0x00000000, 0x00000000, 0x0};  /* 2 */
    ck_assert_decimal_eq(s21_round(dec), control_dec);
}
END_TEST
...
START_TEST(round_test_24) {
    s21_decimal dec = {0x00000011, 0x00000000, 0x00000000, 0x80010000, 0x0};          /* -1.7 */
    s21_decimal control_dec = {0x00000002, 0x00000000, 0x00000000, 0x80000000, 0x0};  /* -2 */
    ck_assert_decimal_eq(s21_round(dec), control_dec);
}
END_TEST
...
START_TEST(greater_equal_INFs) {
    s21_decimal dec1 = {0x00002EE0, 0x00000000, 0x00000000, 0x00030000, 0x1};  /* 12.000 */
    s21_decimal dec2 = {0x0000000C, 0x00000000, 0x00000000, 0x00000000, 0x1};  /* 12 */
    ck_assert_int_eq(s21_is_greater_or_equal(dec1, dec2), FALSE);
}
END_TEST

START_TEST(greater_equal_NEG_INFs) {
    s21_decimal dec1 = {0x00002EE0, 0x00000000, 0x00000000, 0x00030000, 0x2};  /* 12.000 */
    s21_decimal dec2 = {0x0000000C, 0x00000000, 0x00000000, 0x00000000, 0x2};  /* 12 */
    ck_assert_int_eq(s21_is_greater_or_equal(dec1, dec2), FALSE);
}
END_TEST

START_TEST(greater_equal_NANs) {
    s21_decimal dec1 = {0x00002EE0, 0x00000000, 0x00000000, 0x00030000, 0x3};  /* 12.000 */
    s21_decimal dec2 = {0x0000000C, 0x00000000, 0x00000000, 0x00000000, 0x3};  /* 12 */
    ck_assert_int_eq(s21_is_greater_or_equal(dec1, dec2), FALSE);
}
END_TEST
...
START_TEST(mul_norm_1) {
    s21_decimal dec1 = {0x000000AA, 0x00000000, 0x00000000, 0x00000000, 0x0};         /* 170 */
    s21_decimal dec2 = {0x0003F7A3, 0x00000000, 0x00000000, 0x00010000, 0x0};         /* 26000.3 */
    s21_decimal control_dec = {0x02A2723E, 0x00000000, 0x00000000, 0x00010000, 0x0};  /* 4420051.0 */
    ck_assert_decimal_eq(s21_mul(dec1, dec2), control_dec);
}
END_TEST

START_TEST(mul_norm_2) {
    s21_decimal dec1 = {0xC0E79423, 0x0000037F, 0x00000000, 0x00060000, 0x0};  /* 3847232.132131 */
    s21_decimal dec2 = {0x138A6875, 0x00000000, 0x00000000, 0x00010000, 0x0};  /* 32783781.3 */
    s21_decimal control_dec = {0xB1E2EBFF, 0x5F9CAC95, 0x00000044, 0x00070000, 0x0};
...
START_TEST(mul_norm_3) {
    s21_decimal dec1 = {0x00020423, 0x00000000, 0x00000000, 0x80060000, 0x0};         /* -0.132131 */
    s21_decimal dec2 = {0x138A6875, 0x00000000, 0x00000000, 0x80010000, 0x0};         /* -32783781.3 */
    s21_decimal control_dec = {0xA6781BFF, 0x00002765, 0x00000000, 0x00070000, 0x0};  /* 4331753.8069503 */
    ck_assert_decimal_eq(s21_mul(dec1, dec2), control_dec);
}
END_TEST

START_TEST(mul_norm_4) {
    s21_decimal dec1 = {0x00000001, 0x00000000, 0x00000000, 0x00060000, 0x0};         /* 0.000001 */
    s21_decimal dec2 = {0x6592E003, 0x00000117, 0x00000000, 0x000B0000, 0x0};         /* 12.00000000003 */
    s21_decimal control_dec = {0x6592E003, 0x00000117, 0x00000000, 0x00110000, 0x0};  /* 0.00001200000000003
    */
    ck_assert_decimal_eq(s21_mul(dec1, dec2), control_dec);
}
END_TEST
...
START_TEST(mul_overflow) {
    s21_decimal dec1 = {0x9F05E2AC, 0xF10F1206, 0x0000007D, 0x00040000, 0x0};  /* 232321313132113231.1212 */
    s21_decimal dec2 = {0x714F71DB, 0x007227FE, 0x00000000, 0x00050000, 0x0};  /* 321321211212.23131 */
    s21_decimal control_dec = {0x8F99899A, 0xC8DBCDE4, 0xF134D6C4, 0x00000000, 0x0};
...
START_TEST(div_test_1) {
    s21_decimal dec1 = {0x0000000A, 0x00000000, 0x00000000, 0x00000000, 0x0};         /* 10 */
    s21_decimal dec2 = {0x00000002, 0x00000000, 0x00000000, 0x00000000, 0x0};         /* 2 */
    s21_decimal control_dec = {0x00000005, 0x00000000, 0x00000000, 0x00000000, 0x0};  /* 5 */
    ck_assert_decimal_eq(s21_div(dec1, dec2), control_dec);
}
END_TEST

START_TEST(div_test_2) {
    s21_decimal dec1 = {0x0000007D, 0x00000000, 0x00000000, 0x00020000, 0x0};  /* 1.25 */
    s21_decimal dec2 = {0x00000087, 0x00000000, 0x00000000, 0x00010000, 0x0};  /* 13.5 */
    s21_decimal control_dec = {0x4897B426, 0x05C10E71, 0x02FDE871, 0x001C0000, 0x0};
...
START_TEST(div_test_3) {
    s21_decimal dec1 = {0x0000007D, 0x00000000, 0x00000000, 0x00000000, 0x0};  /* 125 */
    s21_decimal dec2 = {0x00000087, 0x00000000, 0x00000000, 0x00000000, 0x0};  /* 135 */
    s21_decimal control_dec = {0xD5ED097B, 0x398A906C, 0x1DEB146A, 0x001C0000, 0x0};
...
START_TEST(div_test_4) {
    s21_decimal dec1 = {0x00000001, 0x00000000, 0x00000000, 0x00000000, 0x0};  /* 1 */
    s21_decimal dec2 = {0x00000001, 0x00000000, 0x00000000, 0x001C0000, 0x0};
    /* 0.0000000000000000000000000001 */
    s21_decimal control_dec = {0x10000000, 0x3E250261, 0x204FCE5E, 0x00000000, 0x0};
...
START_TEST(div_test_5) {
    s21_decimal dec1 = {0x00000003, 0x00000000, 0x00000000, 0x00000000, 0x0};         /* 3 */
    s21_decimal dec2 = {0x00000002, 0x00000000, 0x00000000, 0x00000000, 0x0};         /* 2 */
    s21_decimal control_dec = {0x0000000F, 0x00000000, 0x00000000, 0x00010000, 0x0};  /* 1.5 */
    ck_assert_decimal_eq(s21_div(dec1, dec2), control_dec);
}
END_TEST
...
START_TEST(div_test_6) {
    s21_decimal dec1 = {0x00000003, 0x00000000, 0x00000000, 0x80000000, 0x0};         /* -3 */
    s21_decimal dec2 = {0x00000002, 0x00000000, 0x00000000, 0x00000000, 0x0};         /* 2 */
    s21_decimal control_dec = {0x0000000F, 0x00000000, 0x00000000, 0x80010000, 0x0};  /* -1.5 */
    ck_assert_decimal_eq(s21_div(dec1, dec2), control_dec);
}
END_TEST
...
START_TEST(div_test_7) {
    s21_decimal dec1 = {0x00000002, 0x00000000, 0x00000000, 0x00000000, 0x0};  /* 2 */
    s21_decimal dec2 = {0x00000003, 0x00000000, 0x00000000, 0x80000000, 0x0};  /* -3 */
    s21_decimal control_dec = {0x0AAAAAAB, 0x296E0196, 0x158A8994, 0x801C0000, 0x0};
...
START_TEST(div_test_9) {
    s21_decimal dec1 = {0x00000001, 0x00000000, 0x00000000, 0x00000000, 0x0};  /* 1 */
    s21_decimal dec2 = {0x00000009, 0x00000000, 0x00000000, 0x00000000, 0x0};  /* 9 */
    s21_decimal control_dec = {0x571C71C7, 0x06E7AAEE, 0x039716EE, 0x001C0000, 0x0};
...
START_TEST(div_test_10) {
    s21_decimal dec1 = {0x00000002, 0x00000000, 0x00000000, 0x00000000, 0x0};  /* 2 */
    s21_decimal dec2 = {0x00000009, 0x00000000, 0x00000000, 0x00000000, 0x0};  /* 9 */
    s21_decimal control_dec = {0xAE38E38E, 0x0DCF55DC, 0x072E2DDC, 0x001C0000, 0x0};
...
START_TEST(div_test_11) {
    s21_decimal dec1 = {0x00000003, 0x00000000, 0x00000000, 0x00000000, 0x0};  /* 3 */
    s21_decimal dec2 = {0x00000009, 0x00000000, 0x00000000, 0x00000000, 0x0};  /* 9 */
    s21_decimal control_dec = {0x05555555, 0x14B700CB, 0x0AC544CA, 0x001C0000, 0x0};
...
START_TEST(div_test_12) {
    s21_decimal dec1 = {0x00000004, 0x00000000, 0x00000000, 0x00000000, 0x0};  /* 4 */
    s21_decimal dec2 = {0x00000009, 0x00000000, 0x00000000, 0x00000000, 0x0};  /* 9 */
    s21_decimal control_dec = {0x5C71C71C, 0x1B9EABB9, 0x0E5C5BB8, 0x001C0000, 0x0};
...
START_TEST(div_test_13) {
    s21_decimal dec1 = {0x00000005, 0x00000000, 0x00000000, 0x00000000, 0x0};  /* 5 */
    s21_decimal dec2 = {0x00000009, 0x00000000, 0x00000000, 0x00000000, 0x0};  /* 9 */
    s21_decimal control_dec = {0xB38E38E4, 0x228656A7, 0x11F372A6, 0x001C0000, 0x0};
...
START_TEST(div_test_14) {
    s21_decimal dec1 = {0x00000006, 0x00000000, 0x00000000, 0x00000000, 0x0};  /* 6 */
    s21_decimal dec2 = {0x00000009, 0x00000000, 0x00000000, 0x00000000, 0x0};  /* 9 */
    s21_decimal control_dec = {0x0AAAAAAB, 0x296E0196, 0x158A8994, 0x001C0000, 0x0};
    /* 0.6666666666666666666666666667 */
    ck_assert_decimal_eq(s21_div(dec1, dec2), control_dec);
}
END_TEST
...
START_TEST(div_test_15) {
    s21_decimal dec1 = {0x00000007, 0x00000000, 0x00000000, 0x00000000, 0x0};  /* 7 */
    s21_decimal dec2 = {0x00000009, 0x00000000, 0x00000000, 0x00000000, 0x0};  /* 9 */
    s21_decimal control_dec = {0x61C71C72, 0x3055AC84, 0x1921A082, 0x001C0000, 0x0};
...
START_TEST(div_test_16) {
    s21_decimal dec1 = {0x00000008, 0x00000000, 0x00000000, 0x00000000, 0x0};  /* 8 */
    s21_decimal dec2 = {0x00000009, 0x00000000, 0x00000000, 0x00000000, 0x0};  /* 9 */
    s21_decimal control_dec = {0xB8E38E39, 0x373D5772, 0x1CB8B770, 0x001C0000, 0x0};
...
START_TEST(div_test_17) {
    s21_decimal dec1 = {0xB9000000, 0xB7320334, 0x0014ADF4, 0x00000000, 0x0};  /* 25000000000000000000000000
    */
    s21_decimal dec2 = {0x00000001, 0x00000000, 0x00000000, 0x00030000, 0x0};  /* 0.001 */
    s21_decimal control_dec = {0xA8000000, 0x9B5C85F2, 0x50C783EB, 0x00000000, 0x0};
...
START_TEST(div_test_18) {
    s21_decimal dec1 = {0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF, 0x001C0000, 0x0};
...
START_TEST(div_test_19) {
    s21_decimal dec1 = {0x0001E363, 0x00000000, 0x00000000, 0x00000000, 0x0};  /* 123747 */
    s21_decimal dec2 = {0x00000007, 0x00000000, 0x00000000, 0x00000000, 0x0};  /* 7 */
    s21_decimal control_dec = {0x2E249249, 0x8FA8CC61, 0x391F045C, 0x00180000, 0x0};
...
START_TEST(div_test_20) {
    s21_decimal dec1 = {0x0000FA7B, 0x00000000, 0x00000000, 0x00000000, 0x0};  /* 64123 */
    s21_decimal dec2 = {0x00000003, 0x00000000, 0x00000000, 0x00000000, 0x0};  /* 3 */
    s21_decimal control_dec = {0x1E555555, 0xC57ED722, 0x45106F23, 0x00180000, 0x0};
...
START_TEST(div_test_21) {
    s21_decimal dec1 = {0x00000011, 0x00000000, 0x00000000, 0x00000000, 0x0};         /* 17 */
    s21_decimal dec2 = {0x00000010, 0x00000000, 0x00000000, 0x00000000, 0x0};         /* 16 */
    s21_decimal control_dec = {0x00002981, 0x00000000, 0x00000000, 0x00040000, 0x0};  /* 1.0625 */
    ck_assert_decimal_eq(s21_div(dec1, dec2), control_dec);
}
END_TEST
...
START_TEST(div_test_22) {
    s21_decimal dec1 = {0x00000011, 0x00000000, 0x00000000, 0x00000000, 0x0};         /* 17 */
    s21_decimal dec2 = {0x00000004, 0x00000000, 0x00000000, 0x00000000, 0x0};         /* 4 */
    s21_decimal control_dec = {0x000001A9, 0x00000000, 0x00000000, 0x00020000, 0x0};  /* 4.25 */
    ck_assert_decimal_eq(s21_div(dec1, dec2), control_dec);
}
END_TEST

START_TEST(div_test_23) {
    s21_decimal dec1 = {0x0000000F, 0x00000000, 0x00000000, 0x00000000, 0x0};         /* 15 */
    s21_decimal dec2 = {0x00000004, 0x00000000, 0x00000000, 0x00000000, 0x0};         /* 4 */
    s21_decimal control_dec = {0x00000177, 0x00000000, 0x00000000, 0x00020000, 0x0};  /* 3.75 */
    ck_assert_decimal_eq(s21_div(dec1, dec2), control_dec);
}
END_TEST

START_TEST(floor_test_1) {
    s21_decimal dec = {0x00000013, 0x00000000, 0x00000000, 0x00010000, 0x0};          /* 1.9 */
    s21_decimal control_dec = {0x00000001, 0x00000000, 0x00000000, 0x00000000, 0x0};  /* 1 */
    ck_assert_decimal_eq(s21_floor(dec), control_dec);
}
END_TEST

START_TEST(floor_test_2) {
    s21_decimal dec = {0x0000004F, 0x00000000, 0x00000000, 0x001C0000, 0x0};
...
START_TEST(floor_test_3) {
    s21_decimal dec = {0x0000000B, 0x00000000, 0x00000000, 0x80010000, 0x0};          /* -1.1 */
    s21_decimal control_dec = {0x00000002, 0x00000000, 0x00000000, 0x80000000, 0x0};  /* -2 */
    ck_assert_decimal_eq(s21_floor(dec), control_dec);
}
END_TEST
...
START_TEST(floor_test_4) {
    s21_decimal dec = {0x0000004F, 0x00000000, 0x00000000, 0x801C0000, 0x0};
    /* -0.0000000000000000000000000079 */
    s21_decimal control_dec = {0x00000001, 0x00000000, 0x00000000, 0x80000000, 0x0};  /* -1 */
    ck_assert_decimal_eq(s21_floor(dec), control_dec);
}
...
START_TEST(floor_test_5) {
    s21_decimal dec = {0x00000013, 0x00000000, 0x00000000, 0x80010000, 0x0};          /* -1.9 */
    s21_decimal control_dec = {0x00000002, 0x00000000, 0x00000000, 0x80000000, 0x0};  /* -2 */
    ck_assert_decimal_eq(s21_floor(dec), control_dec);
}
END_TEST
...
START_TEST(floor_test_6) {
    s21_decimal dec = {0x00000036, 0x00000000, 0x00000000, 0x00010000, 0x0};          /* 5.4 */
    s21_decimal control_dec = {0x00000005, 0x00000000, 0x00000000, 0x00000000, 0x0};  /* 5 */
    ck_assert_decimal_eq(s21_floor(dec), control_dec);
}
END_TEST
...
START_TEST(floor_test_7) {
    s21_decimal dec = {0x00000042, 0x00000000, 0x00000000, 0x00010000, 0x0};          /* 6.6 */
    s21_decimal control_dec = {0x00000006, 0x00000000, 0x00000000, 0x00000000, 0x0};  /* 6 */
    ck_assert_decimal_eq(s21_floor(dec), control_dec);
}
END_TEST
...
START_TEST(floor_test_8) {
    s21_decimal dec = {0x0000004B, 0x00000000, 0x00000000, 0x00010000, 0x0};          /* 7.5 */
    s21_decimal control_dec = {0x00000007, 0x00000000, 0x00000000, 0x00000000, 0x0};  /* 8 */
    ck_assert_decimal_eq(s21_floor(dec), control_dec);
}
END_TEST
...
START_TEST(floor_test_10) {
    s21_decimal dec = {0x0000005F, 0x00000000, 0x00000000, 0x00010000, 0x0};          /* 9.5 */
    s21_decimal control_dec = {0x00000009, 0x00000000, 0x00000000, 0x00000000, 0x0};  /* 9 */
    ck_assert_decimal_eq(s21_floor(dec), control_dec);
}
END_TEST
...
START_TEST(floor_test_13) {
    s21_decimal dec = {0x00000019, 0x00000000, 0x00000000, 0x80010000, 0x0};          /* -2.5 */
    s21_decimal control_dec = {0x00000003, 0x00000000, 0x00000000, 0x80000000, 0x0};  /* -3 */
    ck_assert_decimal_eq(s21_floor(dec), control_dec);
}
END_TEST
...
START_TEST(floor_test_17) {
    s21_decimal dec = {0x00000041, 0x00000000, 0x00000000, 0x80010000, 0x0};          /* -6.5 */
    s21_decimal control_dec = {0x00000007, 0x00000000, 0x00000000, 0x80000000, 0x0};  /* -7 */
    ck_assert_decimal_eq(s21_floor(dec), control_dec);
}
END_TEST
...
START_TEST(floor_test_19) {
    s21_decimal dec = {0x00000055, 0x00000000, 0x00000000, 0x80010000, 0x0};          /* -8.5 */
    s21_decimal control_dec = {0x00000009, 0x00000000, 0x00000000, 0x80000000, 0x0};  /* -9 */
    ck_assert_decimal_eq(s21_floor(dec), control_dec);
}
END_TEST
...
START_TEST(mod_test_1) {
    ...
    s21_decimal dec2 = {0x00000004, 0x00000000, 0x00000000, 0x00000000, 0x0};         /* 4 */
    s21_decimal control_dec = {0x00000001, 0x00000000, 0x00000000, 0x00000000, 0x0};  /* 1 */
    ck_assert_decimal_eq(s21_mod(dec1, dec2), control_dec);
}
END_TEST

START_TEST(mod_test_2) {
    s21_decimal dec1 = {0x00000022, 0x00000000, 0x00000000, 0x00000000, 0x0};         /* 34 */
    s21_decimal dec2 = {0x0000000A, 0x00000000, 0x00000000, 0x00000000, 0x0};         /* 10 */
    s21_decimal control_dec = {0x00000004, 0x00000000, 0x00000000, 0x00000000, 0x0};  /* 4 */
    ck_assert_decimal_eq(s21_mod(dec1, dec2), control_dec);
}
...
START_TEST(mod_test_7) {
    s21_decimal dec1 = {0x00000607, 0x00000000, 0x00000000, 0x00000000, 0x0};         /* 1543 */
    s21_decimal dec2 = {0x00000003, 0x00000000, 0x00000000, 0x00000000, 0x0};         /* 3 */
    s21_decimal control_dec = {0x00000001, 0x00000000, 0x00000000, 0x00000000, 0x0};  /* 1 */
    ck_assert_decimal_eq(s21_mod(dec1, dec2), control_dec);
}
...
START_TEST(mod_test_8) {
    s21_decimal dec1 = {0x0000007D, 0x00000000, 0x00000000, 0x00020000, 0x0};         /* 1.25 */
    s21_decimal dec2 = {0x00000087, 0x00000000, 0x00000000, 0x00010000, 0x0};         /* 13.5 */
    s21_decimal control_dec = {0x0000007D, 0x00000000, 0x00000000, 0x00020000, 0x0};  /* 1.25 */
    ck_assert_decimal_eq(s21_mod(dec1, dec2), control_dec);
}
END_TEST
...
START_TEST(float_to_dec_1) {
    float x = 1.5;
    s21_decimal test_dec = {0x00000000, 0x00000000, 0x00000000, 0x00000000, 0x0};  /* 0 */
    s21_from_float_to_decimal(x, &test_dec);
    s21_decimal control = {0x0000000F, 0x00000000, 0x00000000, 0x00010000, 0x0};  /* 1.5 */
...
START_TEST(float_to_dec_2) {
    ...
    s21_decimal test_dec = {0x00000000, 0x00000000, 0x00000000, 0x00000000, 0x0};  /* 0 */
    s21_from_float_to_decimal(x, &test_dec);
    s21_decimal control = {0x0034863A, 0x00000000, 0x00000000, 0x00030000, 0x0};  /* 3442.234 */
    ck_assert_decimal_eq(test_dec, control);
}
END_TEST
...
START_TEST(float_to_dec_4) {
    ...
    s21_decimal test_dec = {0x00000000, 0x00000000, 0x00000000, 0x00000000, 0x0};  /* 0 */
    s21_from_float_to_decimal(x, &test_dec);
    s21_decimal control = {0x00000001, 0x00000000, 0x00000000, 0x001C0000, 0x0};
    /* 0.0000000000000000000000000001 */
    ck_assert_decimal_eq(test_dec, control);
}
END_TEST
...
START_TEST(float_to_dec_5) {
    ...
    s21_decimal test_dec = {0x00000000, 0x00000000, 0x00000000, 0x00000000, 0x0};  /* 0 */
    s21_from_float_to_decimal(x, &test_dec);
    s21_decimal control = {0x000014D5, 0x00000000, 0x00000000, 0x80030000, 0x0};  /* -5.333 */
    ck_assert_decimal_eq(test_dec, control);
}
END_TEST
...
START_TEST(float_to_dec_6) {
    ...
    s21_decimal test_dec = {0x00000000, 0x00000000, 0x00000000, 0x00000000, 0x0};  /* 0 */
    s21_from_float_to_decimal(x, &test_dec);
    s21_decimal control = {0x0032DCD5, 0x00000000, 0x00000000, 0x00070000, 0x0};  /* 0.3333333 */
    ck_assert_decimal_eq(test_dec, control);
}
END_TEST
...
START_TEST(float_to_dec_7) {
    ...
    s21_decimal test_dec = {0x00000000, 0x00000000, 0x00000000, 0x00000000, 0x0};  /* 0 */
    s21_from_float_to_decimal(x, &test_dec);
    s21_decimal control = {0x0054C564, 0x00000000, 0x00000000, 0x00070000, 0x0};  /* 0.5555556 */
    ck_assert_decimal_eq(test_dec, control);
}
END_TEST
...
START_TEST(float_to_dec_8) {
    ...
    s21_decimal test_dec = {0x00000000, 0x00000000, 0x00000000, 0x00000000, 0x0};  /* 0 */
    s21_from_float_to_decimal(x, &test_dec);
    s21_decimal control = {0x000F423F, 0x00000000, 0x00000000, 0x00000000, 0x0};  /* 999999 */
    ck_assert_decimal_eq(test_dec, control);
}
END_TEST
...
START_TEST(float_to_dec_9) {
    ...
    s21_decimal test_dec = {0x00000000, 0x00000000, 0x00000000, 0x00000000, 0x0};  /* 0 */
    s21_from_float_to_decimal(x, &test_dec);
    s21_decimal control = {0x00000000, 0x00000000, 0x00000000, 0x00000000, 0x0};  /* 0 */
    ck_assert_decimal_eq(test_dec, control);
}
END_TEST
...
START_TEST(float_to_dec_10) {
    ...
    s21_decimal test_dec = {0x00000000, 0x00000000, 0x00000000, 0x00000000, 0x0};  /* 0 */
    s21_from_float_to_decimal(x, &test_dec);
    s21_decimal control = {0x000F4240, 0x00000000, 0x00000000, 0x00000000, 0x0};  /* 1000000 */
    ck_assert_decimal_eq(test_dec, control);
}
END_TEST
...
START_TEST(float_to_dec_11) {
    ...
    s21_decimal test_dec = {0x00000000, 0x00000000, 0x00000000, 0x00000000, 0x0};  /* 0 */
    s21_from_float_to_decimal(x, &test_dec);
    s21_decimal control = {0x0000000F, 0x00000000, 0x00000000, 0x80150000, 0x0};  /* -0.000000000000000000015
    */
    ck_assert_decimal_eq(test_dec, control);
}
END_TEST
...
START_TEST(float_to_dec_12) {
    ...
    s21_decimal test_dec = {0x00000000, 0x00000000, 0x00000000, 0x00000000, 0x0};  /* 0 */
    s21_from_float_to_decimal(x, &test_dec);
    s21_decimal control = {0x00000000, 0x00000000, 0x00000000, 0x00000000, s21_INFINITY};  /* 0 */
    ck_assert_decimal_eq(test_dec, control);
}
END_TEST
...
START_TEST(float_to_dec_13) {
    ...
    s21_decimal test_dec = {0x00000000, 0x00000000, 0x00000000, 0x00000000, 0x0};  /* 0 */
    s21_from_float_to_decimal(x, &test_dec);
    s21_decimal control = {0x00000000, 0x00000000, 0x00000000, 0x00000000, s21_NEGATIVE_INFINITY};  /* 0 */
    ck_assert_decimal_eq(test_dec, control);
}
END_TEST
...
START_TEST(float_to_dec_14) {
    ...
    s21_decimal test_dec = {0x00000000, 0x00000000, 0x00000000, 0x00000000, 0x0};  /* 0 */
    s21_from_float_to_decimal(x, &test_dec);
    s21_decimal control = {0x00000000, 0x00000000, 0x00000000, 0x00000000, s21_NAN};  /* 0 */
    ck_assert_decimal_eq(test_dec, control);
}
END_TEST
...
START_TEST(float_to_dec_15) {
    float x = 0.0;
    s21_decimal* test_dec = NULL;
    ck_assert_int_eq(s21_from_float_to_decimal(x, test_dec), CONVERTING_ERROR);
}
END_TEST
...
Suite* decimal_suite(void) {
    ...
    tcase_add_test(tc_core, less_1_NEG_INF_2_INF);
